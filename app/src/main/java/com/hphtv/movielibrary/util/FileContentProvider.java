...
public class FileContentProvider extends ContentProvider {
    public static final String FILE_PROVIDER_PREFIX = "content://com.hphtv.movielibrary.fileprovider";
    public static final String AUTHORITY = "com.hphtv.movielibrary.fileprovider";
